    ...
    <div className="px-4 pb-16 pt-12 sm:px-6 lg:px-8">
      ...
      <section className="mx-auto mt-20 max-w-4xl space-y-6 rounded-[36px] border border-border/70 bg-gradient-to-br from-background via-background to-muted/40 p-8 sm:p-12">
        ...
        <div className="grid gap-6 sm:grid-cols-3">
          {["Apply", "Interview", "Party"].map((step, index) => (
            <Card key={step} className="border-border/60 bg-card/90">
              <CardHeader>
              ...
              <CardContent className="text-sm text-muted-foreground">
                {index === 0 && "Tell us about yourself, your vibe, and the energy you bring into a room."}
                {index === 1 && "We meet 1:1—virtually or over a martini—to understand your story and what you seek."}
                {index === 2 && "Choose your first salon, RSVP with one tap, and let the hosts take care of the rest."}
              </CardContent>
            </Card>
          ))}
        </div>
